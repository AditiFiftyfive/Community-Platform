  ...
  if (activeTab === "analytics") { 
    return ( 
      <div className="text-center py-8"> 
        ...
        <p className="text-slate-600">Community analytics and insights will be displayed here</p> 
      </div> 
    ); 
  } 
  ...
  if (activeTab === "settings") { 
    return ( 
      <div className="text-center py-8"> 
        ...
        <p className="text-slate-600">Community settings and configuration options</p> 
      </div> 
    ); 
  } 
